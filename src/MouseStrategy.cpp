...
//   const char *format, ...)
      ...
      al_draw_textf(mouse_font , al_map_rgb(255,127,0) ,
            al_get_bitmap_width(fcfs_mouse_buffer) - al_get_text_width(mouse_font , "0") ,
            al_get_bitmap_height(fcfs_mouse_buffer) - al_get_font_line_height(mouse_font),
            0,
